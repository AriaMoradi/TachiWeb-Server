...
curl "https://android.googlesource.com/platform/prebuilts/sdk/+/f838d0a8253fc9a492faaa02d526da827de3c129/29/public/android.jar?format=TEXT" | base64 --decode > android.jar
